...
export default function Icon(props: IconProps) {
  ...
  const { className, type = 'pin', size = 16, ...otherProps } = props
  ...
  return React.cloneElement(svg, { style, className: cls, ...otherProps })
}
